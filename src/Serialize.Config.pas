{ =============================================================================
  Serialize.Config - Configuracao global (singleton) de export/import JSON
  ...
  Absorvido de FontesReferencias/dataset-serialize/src/DataSet.Serialize.Config.pas
  (namespace DataSet.Serialize.Config -> Serialize.Config). Conteudo verbatim
  - TDataSetSerializeConfig.GetInstance (singleton) + TDataSetSerializeConfigExport/
  TDataSetSerializeConfigImport (formatos de data/hora/moeda/float, prefixos de
  dataset filho, CaseNameDefinition, etc.).

  Changelog (file):
  - 1.0.0 (13/07/2026): versao inicial (FASE 5 Onda 9) - absorcao TOTAL do
    dataset-serialize, header v3.
  ============================================================================= }
unit Serialize.Config;
